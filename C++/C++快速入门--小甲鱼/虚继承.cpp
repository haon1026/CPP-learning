...
{
public:
    TeachingStudent(std::string theName, std::string teachclass, std::string attendclass) : Teacher(theName, teachclass), Student(theName, attendclass), Person(theName) {}
...
{
    std::cout << "大家好，我是" << name << ",我教" << Teacher::classes << ",同时我在" << Student::classes << "学习" << std::endl;
}
